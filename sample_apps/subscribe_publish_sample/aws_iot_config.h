...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "A1QCLP14LZA6X4.iot.eu-west-1.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
#define AWS_IOT_MQTT_PORT              8883 ///< default port for MQTT/S
#define AWS_IOT_MQTT_CLIENT_ID         "cms_gh_1eg15" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME 		   "cms_gh_1eg15" ///< Thing Name of the Shadow this device is associated with
#define AWS_IOT_ROOT_CA_FILENAME       "VeriSign_aws_root_ca.pem" ///< Root CA file name
#define AWS_IOT_CERTIFICATE_FILENAME   "71cee54f53-certificate.pem.crt" ///< device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_FILENAME   "71cee54f53-private.pem.key" ///< Device private key filename
// =================================================
